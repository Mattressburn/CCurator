(function initCaseCleanerDomHide(global) {
  "use strict";

  var HIDDEN_ATTR = "data-casecleaner-hidden";
  var PLACEHOLDER_ATTR = "data-casecleaner-placeholder";
  var LINK_ATTR = "data-casecleaner-link";
  var PREV_STYLE_ATTR = "data-casecleaner-prevstyle";
  ...
  function hideEl(el, label) {
    ...
    text.textContent = label || "Duplicate wrapper hidden by Case Ingestor";
